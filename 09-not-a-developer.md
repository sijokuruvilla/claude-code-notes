---
layout: post
title: How to use Claude Code if you're not a developer
permalink: /not-a-developer
---
...
<nav style="display: flex; flex-direction: column; gap: 5px; margin-top: 10px; padding-top: 20px; border-top: 1px solid #eee;">
  <div>
    <a href="/claude-code-for-business" style="text-decoration: none; color: #0366d6;">← Previous: Claude Code for business owners</a>
  </div>
  <div>
